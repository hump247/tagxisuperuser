...
import 'package:tagxisuperuser/pages/NavigatorPages/historydetails.dart';
                                                                                  ...
                                                                                  (myHistory[i]['payment_opt'] == '1')
                                                                                      ...
                                                                                      : (myHistory[i]['payment_opt'] == '2')
                                                                                          ...
                                                                                          : (myHistory[i]['payment_opt'] == '0')
                                                                                              ...
                                                                                              : '',
                                                                                  style: GoogleFonts.roboto(fontSize: media.width * twelve, fontWeight: FontWeight.w600, color: textColor),
                                                                                ),
                                                                              ],
                                                                            ),
                                                                          ],
                                                                              ...
                                                                              Column(
                                                                                children: [
                                                                                  Text(
                                                                                    ...
                                                                                    style: GoogleFonts.roboto(fontSize: media.width * sixteen, fontWeight: FontWeight.bold, color: textColor),
                                                                                  ),
                                                                                  SizedBox(
                                                                                    height: media.width * 0.01,
                                                                                  ),
